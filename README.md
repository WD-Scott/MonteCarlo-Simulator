...
## Synopsis:
**``Monte Carlo Package``** python package has three classes: ``Die``, ``Game``, and ``Analyzer``. Class descriptions and demonstration code are included below to demo how to install and import the package and how to use the three classes.
